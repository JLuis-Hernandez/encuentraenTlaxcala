...
<?php 
    ...
    //if(!isset($_SESSION['sess_username']) && $rol!="Gratis"){
       if ( ! ($_SESSION['autenticado'] == 'SI' && isset($_SESSION['sess_userrole'])) && $rol!="0")
    ...
    if(strcmp ($password , $pass) == 0){
        if(strcmp ($password1 , $password2) == 0){
            ...
            echo "<script>location.href = '1perfil';</script>";
        }else{
            echo "<script>alert('Tú nueva contraseña no coinciden ...Por favor vulve a intentar');</script>";
            echo "<script>location.href = '1Actualizar_contrasena';</script>";
        }
    }else{
