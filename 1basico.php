		...
		<div class="sap_tabs">	
				     <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						  ...
						  <ul style="margin-left: 20%; float: left;">
						  	  <li class="resp-tab-item " aria-controls="tab_item-0" role="tab"><span>Descripci&oacute;n</span></li>
...
<div class=" col-md-si">
<?php
       $resultado = mysql_query("select idAnuncio, nombreNegocio, categoria, municipio,  img1, img2 from cliente, anuncios where cliente.idCliente=anuncios.idCliente and cliente.rol=1  ORDER BY RAND() LIMIT 3; ");
