...
<div id="elementovip" class="col-md-2">
  <aside>
  <ul>
    <li class="store"><span><img style="width: 30px; position: absolute; margin-left: 10px; margin-top: 10px;" src="images/iconos/trabajos.png"></span><a href="1resultadodebusqueda?servicio=Empleos&municipio=" id="textito-no">Busco Empleo</a></li>
    <li class="movies"><span><img style="width: 30px; position: absolute; margin-left: 10px; margin-top: 10px;" src="images/iconos/salud.png"></span><a href="1resultadodebusqueda?servicio=Servicios+de+Salud&municipio=" id="textito-no">Servicios de salud</a></li>
    <li class="music"><span class="movies-icon"></span><a href="1resultadodebusqueda?servicio=Centros+de+entrenimiento&municipio=" id="textito-no">Centro de entretenimiento</a></li>
    <li class="books"><span><img style="width: 30px; position: absolute; margin-left: 10px; margin-top: 10px;" src="images/iconos/hospedaje.png"></span><a href="1resultadodebusqueda?servicio=Hospedajes&municipio=" id="textito-no">Hospedaje</a></li>
    <li class="magazines"><span><img style="width: 30px; position: absolute; margin-left: 10px; margin-top: 10px;" src="images/iconos/alimentos.png"></span><a href="1resultadodebusqueda?servicio=Alimentos+%26+bebidas&municipio=" id="textito-no">Alimentos & Bebidas</a></li>
    <li class="devices"><span><img style="width: 30px; position: absolute; margin-left: 10px; margin-top: 10px;" src="images/iconos/bienes-raices.png"></span><a href="1resultadodebusqueda?servicio=BIenes+raíces&municipio=" id="textito-no">Bienes ra&#237;ces</a></li>
    <li class="turismo"><span><img style="width: 30px; position: absolute; margin-left: 10px; margin-top: 10px;" src="images/iconos/piramide.png"></span><a href="1resultadodebusqueda?servicio=Turismo+%26+Recreación&municipio=" id="textito-no">Turismo & Recreaci&#243;n</a></li>
    <li class="servicii"><span><img style="width: 30px; position: absolute; margin-left: 10px; margin-top: 10px;" src="images/iconos/tecnologia-informatica.png"></span><a href="1resultadodebusqueda?servicio=Tecnologías+e+informática&municipio=" id="textito-no">Tecnolog&#237;a</a></li>
    <li class="turismo"><span><img style="width: 30px; position: absolute; margin-left: 10px; margin-top: 10px;" src="images/iconos/hospital.png"></span><a href="1resultadodebusqueda?servicio=Servicios+de+Salud&municipio=" id="textito-no">Servicios de salud</a></li>
    
    <li class="devices"><span><img style="width: 30px; position: absolute; margin-left: 10px; margin-top: 10px;" src="images/iconos/mascotas.png"></span><a href="1resultadodebusqueda?servicio=Mascotas&municipio=" id="textito-no">Mascotas</a></li>
    <li class="magazines"><span><img style="width: 30px; position: absolute; margin-left: 10px; margin-top: 10px;" src="images/iconos/autos.png"></span><a href="1resultadodebusqueda?servicio=Automotriz&municipio=" id="textito-no">Automotriz</a></li>
    <li class="books"><span class="magazines-icon"></span><a href="1resultadodebusqueda?servicio=Materiales+de+Construcción&municipio=" id="textito-no">Material de construción</a></li>
    <li class="music"><span><img style="width: 30px; position: absolute; margin-left: 10px; margin-top: 10px;" src="images/iconos/purificadora.png"></span><a href="1resultadodebusqueda?servicio=Purificadoras&municipio=" id="textito-no">Purificadoras</a></li>
  </ul>
</aside>
</div>
			    ...
			    <div class="container">
    				...
    				<div id="banner-categoria">
        				<marquee id="principal-pc-b"  behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();">
                            <a href="https://encuentraentlaxcala.com/1resultadodebusqueda?servicio=Bienes+ra%C3%ADces&municipio=" style="color: #ffffff; text-decoration: none;"><img width="20px;" src="images/iconos/casa.png"> Bienes Ríces</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="https://encuentraentlaxcala.com/1resultadodebusqueda?servicio=Empleos&municipio=" style="color: #ffffff; text-decoration: none;"><img width="20px;" src="images/iconos/trabajos.png"> Empleos</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="https://encuentraentlaxcala.com/1resultadodebusqueda?servicio=Mascotas&municipio=" style="color: #ffffff; text-decoration: none;"><img width="20px;" src="images/iconos/mascos.png"> Mascotas</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="https://encuentraentlaxcala.com/1resultadodebusqueda?servicio=Tecnolog%C3%ADas+e+inform%C3%A1tica&municipio=" style="color: #ffffff; text-decoration: none;"><img width="20px;" src="images/iconos/tiendas.png"> Tiendas Online</a>
                        </marquee>
                    </div>
...
<div id="buscador-logo">
           <form action="1resultadodebusqueda" method="get">
			...
			<div class="col-md-12 login-do1">
			 <br>
			    <center><a href="https://encuentraentlaxcala.com/1index"><img id="logito" width="150px" src="images/logi.png"></a></center>
			 <br>
    ...
    while ($row = mysql_fetch_array($resultado, MYSQL_ASSOC))
    {
      echo "
						...
						<div class='banner-grid'>
							<center><h2>".utf8_decode(utf8_encode($row['nombreNegocio']))."</h2></center>
							<div class='wome'>
							<a href='1vip?id=".$row['idAnuncio']."'>
								<img class='img-responsive' src=".$row['img1']." />
								</a>
								<div class='women simpleCart_shelfItem'>
									<h6 style='color: #ff0000;''>".utf8_decode(utf8_encode($row['categoria']))."</h6>
									<p class='ba-price'><em class='item_price'>".utf8_decode(utf8_encode($row['municipio']))."</em><br></p>
									<a href='1vip?id=".$row['idAnuncio']."' data-text='Ver anuncio' class='but-hover1 item_add'>Ver anuncio</a>
								</div>							
							</div>							
						</div>
					</li>
...
<div class='col-sm-3 item-grid simpleCart_shelfItem'>
							<div class='grid-pro'>
								...
								<div class='women'>
									...
									<a href='1plus?id=".$row['idAnuncio']."' data-text='Ver anuncio' class='but-hover1 item_add'>Ver anuncio</a>
								</div>
								</div>
						</div>
      ";
				...
				<div id="categoria-pc" class="content-top">
					<div class="col-md-12 col-md2 animated wow fadeInLeft" data-wow-delay=".1s">
            			...
            			<div  class="col-sm-4 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadodebusqueda?servicio=Automotriz&municipio=">
            			...
            			<div  class="col-sm-4 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadodebusqueda?servicio=BIenes+raíces&municipio=">
            			...
            			<div  class="col-sm-4 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadodebusqueda?servicio=Tecnologías+e+informática&municipio=">
            			...
            			<div  class="col-sm-4 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadodebusqueda?servicio=Mascotas&municipio=">
            			...
            			<div  class="col-sm-4 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadodebusqueda?servicio=Ropa&municipio=">
            			...
            			<div  class="col-sm-3 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadodebusqueda?servicio=Empleos&municipio=">
            			...
            			<div  class="col-sm-4 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadodebusqueda?servicio=Materiales+de+Construcci%C3%B3n&municipio=">
            			...
            			<div  class="col-sm-4 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadodebusqueda?servicio=Servicios+de+Salud&municipio=">
                ...
                <div id="categoria-movil" class="content-top">
					<div class="col-md-12 col-md2 animated wow fadeInLeft" data-wow-delay=".1s">
            			...
            			<div  class="col-sm-6 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadocategorias?id=5">
            			...
            			<div  class="col-sm-6 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadocategorias?id=7">
            			...
            			<div  class="col-sm-6 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadocategorias?id=19">
            			...
            			<div  class="col-sm-6 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadocategorias?id=3">
            			...
            			<div  class="col-sm-6 item-grid simpleCart_shelfItem">
            				<a style="text-decoration: none;" href="1resultadocategorias?id=28">
      ...
      echo "
			<div class='col-sm-3 item-grid simpleCart_shelfItem'>
				<div class='grid-pro'>
						...
						<div  class='grid-product' >
							<center><figure>	
								<a href='1basico?id=".$row['idAnuncio']."'>
									<div class='grid-img'>
										<img  src=".$row['img1']." class='img-responsive'>
									</div>
									<div class='grid-img'>
					...
					<div class='women'>
						<h6  style='color: #ff0000;'>".utf8_encode($row['categoria'])."</a></h6>
						<p><em class='item_price'>".utf8_decode(utf8_encode($row['municipio']))."</em> <br></p>
						<a href='1basico?id=".$row['idAnuncio']."' data-text='Ver anuncio' class='but-hover1 item_add'>Ver anuncio</a>
					</div>
				</div><br>
			</div>
      ";
