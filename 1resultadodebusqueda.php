...
<body>
<?php
	    include('1categorias-principales.php');
    ?>
...
<?php
  ...
  if ($servicio == null  and $municipio == null){
    ...
    elseif($resultado){
      ...
      echo "<a href='1resultadodebusqueda?servicio=$servicio&municipio=$municipio&pagina=1'>".'&laquo; '."</a>";

      for ($i=1; $i <=$totalPaginas ; $i++) { 
        echo "<a href='1resultadodebusqueda?servicio=$servicio&municipio=$municipio&pagina=".$i."' class='active'>".$i."</a>";
      }
      if ($totalPaginas>1)  
      {
        echo "<a href='1resultadodebusqueda?servicio=$servicio&municipio=$municipio&pagina=$totalPaginas'>".'&raquo'."</a>";
      }
      echo "</div></div>";
    }else echo 'error';
    ...
    elseif($resultado){
      ...
      for ($i=1; $i <=$totalPaginas ; $i++) { 
        echo "<a href='1resultadodebusqueda?servicio=$servicio&municipio=$municipio&pagina=".$i."'>".$i."</a>";
      }
      if ($totalPaginas>1) 
      {
        echo "<a href='1resultadodebusqueda?servicio=$servicio&municipio=$municipio&pagina=$totalPaginas'>".'&raquo'."</a></center>";
      }
      echo "</div></div>";
    }else echo 'error';
  }elseif ($servicio != null and $municipio == null){
        ...
        <div class='col-sm-4 item-grid simpleCart_shelfItem'>
          <div style='height: 366px;' class='grid-pro'>
            ...
            <div class='women'>
              ...
              <p><em class='item_price'>".utf8_encode($row['municipio']).", Tlaxcala</em> <br></p><br>
              <a href='1empleos?id=".$row['idEmpleos']."' data-text='Ver empleo' class='but-hover1 item_add'>Ver empleo</a>
            </div>
          </div><br><br>
        </div>
      ";
