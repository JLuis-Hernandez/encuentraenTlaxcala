...
while ($row = mysql_fetch_array($sql))
{
  ...
  $linkYoutube = utf8_encode($row['linkYoutube']);
  $linkGoogle = utf8_encode($row['linkGoogle']);
	...
	<div class="container">
		...
		<div class="flexslider">
			  <ul class="slides">
			    ...
			    <li data-thumb="images/iconos/video.gif">
			         <div class="thumb-image"> <iframe width="332" height="330" src="<?php echo $linkYoutube ?>" frameborder="0" allowfullscreen></iframe> </div>
			    </li>
...
<div class="col-md-7 single-top-in">
				...
				<center><h3> <?php echo $nombre; ?></h3>
				<p class="in-para"> <?php echo $categoria; ?>,  <?php echo $subcategoria; ?></p></center>
		...
		<div class="sap_tabs">	
				     <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						  <!--<ul style="margin-left: 8%; float: left;" class="resp-tabs-list cl-effect-20">-->
						  <ul style="margin-left: 8%; float: left;">
							  ...
							  <li class="resp-tab-item" aria-controls="tab_item-3" role="tab"><span>Ubicaci&#243;n</span></li>
							  <div class="clearfix"></div>
						  </ul>			  	 
			...
			<script>$( function() { $( 'audio' ).audioPlayer(); } );</script>
							   ...
							   <h2 class="resp-accordion" role="tab" aria-controls="tab_item-3"><span class="resp-arrow"></span><span style="font-size: 20px;">Redes sociales</span></h2>
							      <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
									 <div class="comments-top-top">
										<div><br>
											<h6><iframe src="<?php echo $linkGoogle ?>" width="470" height="300" frameborder="0" style="border:0" allowfullscreen></iframe></h6>
										</div>
									</div>
							 </div>
					      </div>
