...
<!-- contact -->
	<div class="login">
		...
		<form action="2Actualizar_contrasena_conf" method="post">
		<div class="page-header">
      	...
      	<div class="col-md-3">
			...
			<div class="col-md-6 login-do1 animated wow fadeInLeft" data-wow-delay=".5s">
				...
				<div class="login-mail">
					<input type="password" name="contrasenaCliente1" placeholder="Por Favor ingresa tu nueva contraseña" required="">
					<i class="glyphicon glyphicon-lock"></i>
				</div>
			
				<div class="login-mail">
					<input type="password" name="contrasenaCliente2" placeholder="Por Favor repita su contraseña"   required>
					<i class="glyphicon glyphicon-lock"></i>
				</div>
			...
			<div class="login-do animated wow fadeInRight" data-wow-delay=".5s"><br>
				<label class="hvr-sweep-to-top login-sub">
				<input class="Cancelar" type="submit"     value="Guardar"/>
				</label>
			</div>
