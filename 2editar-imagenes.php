	...
	<div class="header">
			...
			<nav><a title="Cerra menu" style="color: #ff0000;" class="burger"  href="#"><span class="burger" style="color: #ff0000;"></span></a>
              <ul class="main">
                ...
                <li><a href="2promociones">Promociones</a></li>
...
<div class="banner-top">
	<div class="container">
		...
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="2perfil">Perfil</a><label>/</label>Actualizar datos</h3>
		<div class="clearfix"> </div>
	</div>
</div>
<!-- contact -->
    ...
    $query = "SELECT idAnuncio, nombreNegocio, descripcion, categoria, subcategoria, domicilio, codPostal, municipio, coloniaLocalidad, telefono, correoNegocio, facebook, twitter, img1, img2 FROM anuncios where idCliente='".$_SESSION['sess_user_id']."' ";
			...
			<div class="col-md-6 login-do animated wow fadeInRight" data-wow-delay=".5s">
				<div class="login-mail">
				 ...
				 <input id="fotitoo"  type="file" value="Upload" name="foto2" onchange="previewFile();"  />
			       </div>
			       </div></center>
				</div>
			</div>
...
error_reporting(E_ALL ^ E_DEPRECATED);
  ...
  if(isset($_POST['registrar'])){
    ...
    $sqlAnuncio = mysql_query("update anuncios set img1='$dest_img1', img2='$dest_img2' where idCliente='".$_SESSION['sess_user_id']."' ");
    if($sqlAnuncio){
