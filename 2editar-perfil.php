...
<link href='//fonts.googleapis.com/css?family=Lato:400,100,300,700,900' rel='stylesheet' type='text/css'></head>
	<script type="text/javascript">
		...
		<script type="text/javascript">
			...
			{
			    ObjReader = new FileReader();
			    ObjReader.readAsDataURL(document.getElementById("fotitoo").files[0]);
			    ObjReader.onload = function (ObjEvent) {
		...
		<div class="page-header">
			...
			<div class="col-md-6" data-wow-delay=".5s">
				<div style="border-color: #800000; border-width: 1px;" class="login-mail">
					<input style="background: #fff;" value="<?php if (isset($_SESSION['nombreCliente'])) { echo ''.$_SESSION['nombreCliente'].'&nbsp;'; } ?>" disabled="disabled" name="nombre" type="text" placeholder="Nombre(s) " required autofocus>
			...
			<div class="col-md-6 " data-wow-delay=".5s">
			    <div style="border-color: #800000; border-width: 1px;"  class="login-mail">
					<input style="background: #fff;" value="<?php if (isset($_SESSION['apellidosCliente'])) { echo ''.$_SESSION['apellidosCliente'].'&nbsp;'; } ?>" disabled="disabled" name="apellidos" type="text" placeholder="Apellidos" required autofocus>
					<i><img width="16px;" src="images/iconos/usuario.png"></i>
				</div>
			</div>
			...
			<div class="col-md-6" data-wow-delay=".5s">
			    <div style="border-color: #800000; border-width: 1px;"  class="login-mail">
					<input  style="background: #fff;" type="text" value="<?php if (isset($_SESSION['correoCliente'])) { echo ''.$_SESSION['correoCliente'].'&nbsp;'; } ?>" disabled="disabled">
			...
			<div class="col-md-6" data-wow-delay=".5s">
			    <div style="border-color: #800000; border-width: 1px;"  class="login-mail">
					<input  style="background: #fff;" type="password" name="contrasena" type="password" value="***************" disabled="disabled">
					<i><a style="text-decoration: none;" href="2Actualizar_contrasena"><img width="16px;" src="images/iconos/contrasef.png"> Editar contrase&#241;a</i></a>
				</div>
			</div>
...
die ('Error al seleccionar BD : ' . mysql_error());
    ...
    $query = "SELECT idAnuncio, nombreNegocio, descripcion, categoria, subcategoria, domicilio, codPostal, municipio, coloniaLocalidad, telefono, correoNegocio, facebook, twitter FROM anuncios where idCliente='".$_SESSION['sess_user_id']."' ";
			...
			<div class="col-md-3">
			    <center><b style="color: #ffffff; font-size: 19px;">CATEGOR&#205;AS DESTACADAS</b></center><br>
			        <ul style="margin-left: 55px;">
			            ...
			            <li><a href="2resultadodebusqueda?servicio=BIenes+raíces&municipio=" style="color: #ffffff;"><img width="16px;" src="images/iconos/bienes-raices.png"> Bienes ra&#237;ces</a></li>
			            <li><a href="2resultadodebusqueda?servicio=Tecnologías+e+informática&municipio=" style="color: #ffffff;"><img width="16px;" src="images/iconos/tecnologia-informatica.png"> Tecnolog&#237;a e Inform&#225;tica</a></li>
...
error_reporting(E_ALL ^ E_DEPRECATED);
  ...
  if(isset($_POST['registrar'])){
   ...
   // $codPost = $_POST['codPost'];
    ...
    $sqlAnuncio = mysql_query("update anuncios set  descripcion='$desc',  telefono='$telefono', correoNegocio='$correoEmpresa', facebook='$face', twitter='$twitter' where idCliente='".$_SESSION['sess_user_id']."' ");
    if($sqlAnuncio){
      echo "<script>alert('Tu informaci\u00F3n fue actuaizada correctamente.');</script>";
      echo "<script>location.href = '2perfil';</script>";
    }
  }
  ?>
  <?php
