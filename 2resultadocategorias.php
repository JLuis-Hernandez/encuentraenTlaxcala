...
<div class="col-md-7 single-top-in">
			<div class="categories animated wow fadeInUp animated" data-wow-delay=".5s" >
                ...
                while ($row = mysql_fetch_array($sql)){
                  echo "<i class='glyphicon glyphicon-menu-right'></i><a  href='2resultadodebusqueda?servicio=".utf8_encode($row['nombreCategoria'])."&municipio=' style='text-decoration: none; color: black;'> ".utf8_encode($row['nombreCategoria'])."</a><br>";
                }
                ?></li>
    				</ul>
				</div>
