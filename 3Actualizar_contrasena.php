...
<!-- contact -->
	<div class="login">
		...
		<form action="3Actualizar_contrasena_conf" method="post">
		<div class="page-header">
      	...
      	<div class="col-md-3">
			...
			<div class="col-md-6 login-do1 animated wow fadeInLeft" data-wow-delay=".5s">
				<div class="login-mail">
					<input name="contrasenaCliente" type="password" placeholder="Por Favor ingresa tu contraseña actual" required autofocus>
					<i class="glyphicon glyphicon-lock"></i>
				</div>
				<div class="login-mail">
					<input name="contrasena1" type="password" placeholder="Por Favor ingresa tu nueva contraseña" required>
					<i class="glyphicon glyphicon-lock"></i>
				</div>
			
				<div class="login-mail">
					<input name="contrasena2" type="password" placeholder="Por Favor repita su contraseña" required autofocus>
					<i class="glyphicon glyphicon-lock"></i>
				</div>
			...
			<div class="login-do animated wow fadeInRight" data-wow-delay=".5s"><br>
				<label class="hvr-sweep-to-top login-sub">
					<input type="submit" name="registrar" value="Guardar"></label>
			</div>
