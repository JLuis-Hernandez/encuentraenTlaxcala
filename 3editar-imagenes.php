...
<html>
<head>
<title>Editar fotos del anuncio</title>
<!-- for-mobile-apps -->
...
die ('Error al seleccionar BD : ' . mysql_error());
    ...
    $query = "SELECT idAnuncio, img1, img2, img3, img4, img5 FROM anuncios where idCliente='".$_SESSION['sess_user_id']."' ";
...
error_reporting(E_ALL ^ E_DEPRECATED);
  ...
  if(isset($_POST['registrar'])){
    ...
    if($sqlAnuncio){
      echo "<script>alert('Tus fotos se actualiso correctamente.');</script>";
