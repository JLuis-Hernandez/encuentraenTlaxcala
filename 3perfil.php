...
<div class="banner-top">
	<div class="container">
		<h2 class="animated wow fadeInLeft" data-wow-delay=".5s">PERFIL PLUS</h2>
		<div class="clearfix"> </div>
	</div>
</div>
<!-- contact -->
      ...
      <div class="row wow fadeInRight animated">
          <div class="col-sm-12">
               <center>
                ...
                <a href="3editar-imagenes">ACTUALIZAR IM&Aacute;GENES</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <a href="3editar-audio">ACTUALIZAR AUDIO</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <a href="3editar-perfil">ACTUALIZAR DATOS</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <a href="3Actualizar_contrasena">ACTUALIZAR CONTRASE&#209;A</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                  <?php
...
die ('Error al seleccionar BD : ' . mysql_error());
            ...
            ?>
                                ...
                                <?php echo "<a href='3plus?id=$rsEmp[idCliente]&amp;nombreNegocio=$rsEmp[nombreNegocio]&amp;categoria=$rsEmp[categoria]'>VER ANUNCIO</a>"; ?> 
                                <?php } ?><br><br>
        ...
        <div class="col-sm-7">
          <div class="">
            ...
            <div class="panel-heading">
              <h3 class="panel-title">INFORMACI&Oacute;N DEL USUARIO</h3>
            </div>
            <div class="panel-body">
              <b>ID CLIENTE:</b> <?php if (isset($_SESSION['sess_user_id'])) { echo ''.$_SESSION['sess_user_id'].'P'; } ?><br>
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title">INFORMACI&Oacute;N DEL ANUNCIO</h3>
            </div>
            <div class="panel-body">
           <?php
             //Conectarse a base de datos
...
die ('Error al seleccionar BD : ' . mysql_error());
   ...
   $query = "SELECT idAnuncio, nombreNegocio, descripcion, categoria, subcategoria, domicilio, codPostal, municipio, coloniaLocalidad, telefono, correoNegocio, facebook, twitter, whatsapp, linkSitioWeb, audio, img1, img2, img3, img4, img5 FROM anuncios where idCliente='".$_SESSION['sess_user_id']."' ";
             $queEmp = mysql_query($query) or die(mysql_error());
            ?>
             ...
             <?php while ($rsEmp = mysql_fetch_assoc($queEmp)) { $_SESSION["sess_username"]=$rsEmp['idAnuncio'];?>
              ...
              <b>DESCRIPCI&Oacute;N:</b> <?php echo $rsEmp['descripcion']; ?><br>
        ...
        <div class="col-sm-4">
          <div class="panel panel-danger">
            ...
            <div class="panel-body">
              ...
              <a href="https://api.whatsapp.com/send?phone=522461068540&text=Hola%20quisiera%20saber%20m谩s%20informaci贸n%20sobre%20el%20paquete%20VIP%20de%20Encuentra%20en%20Tlaxcala" target="_blank" style="text-decoration: none; color: #33BB04;"><img width="20px;" src="images/iconos/whatsapp.png"> 246 106 85 40</a><br>
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              ...
              PAQUETE BASICO<br><br>
              <img width="20px;" src="images/iconos/paquete1.png">
              PAQUETE PLUS<br><br>-->
              <img width="30px;" src="images/iconos/paquete2.png">
              PAQUETE VIP
            </div>
          </div>
        </div><!-- /.col-sm-4 -->
