			    ...
			    while ($row = mysql_fetch_array($resultado, MYSQL_ASSOC))
			    	{
			      		...
			      		<div class='col-md-12 col-m1 animated wow fadeInLeft' data-wow-delay='.1s'>
				      		<div class='col-1'>
								...
								<a href='3vip?id=".$row['idAnuncio']."'><img src='".$row['img1']."' style='width: 100%; height: 212px;' class='img-responsive'></a>
								<br><hr><br>
								</div>
								<div class='col-md-6 col-p'>
									<h5>".utf8_encode($row['nombreNegocio'])."</h5>
									<p>".utf8_encode($row['descripcion'])."</p>
									<a href='3vip?id=".$row['idAnuncio']."' class='shop' data-hover='Ver Promoci&#243;n y/o Aviso'>Ver Promoci&#243;n y/o Aviso</a>
