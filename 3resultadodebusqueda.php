...
<?php
  ...
  if ($servicio == null  and $municipio == null){
    ...
    elseif($resultado){
      ...
      echo "<a href='3resultadodebusqueda?servicio=$servicio&municipio=$municipio&pagina=1'>".'&laquo; '."</a>";

      for ($i=1; $i <=$totalPaginas ; $i++) { 
        echo "<a href='3resultadodebusqueda?servicio=$servicio&municipio=$municipio&pagina=".$i."' class='active'>".$i."</a>";
      }
      if ($totalPaginas>1)  
      {
        echo "<a href='3resultadodebusqueda?servicio=$servicio&municipio=$municipio&pagina=$totalPaginas'>".'&raquo'."</a>";
      }
      echo "</div></div>";
    }else echo 'error';
    ...
    elseif($resultado){
      ...
      $totalPaginas = ceil($totalRegistros / $porPagina);
      echo "<div class='center'><div class='pagination'>";
      echo "<center><a href='3resultadodebusqueda?servicio=$servicio&municipio=$municipio&pagina=1'>".'&laquo; '."</a>"; 
      for ($i=1; $i <=$totalPaginas ; $i++) { 
        echo "<a href='3resultadodebusqueda?servicio=$servicio&municipio=$municipio&pagina=".$i."'>".$i."</a>";
      }
      if ($totalPaginas>1) 
      {
        echo "<a href='3resultadodebusqueda?servicio=$servicio&municipio=$municipio&pagina=$totalPaginas'>".'&raquo'."</a></center>";
      }
      echo "</div></div>";
    }else echo 'error';
  }elseif ($servicio != null and $municipio == null){
        ...
        <div class='col-sm-4 item-grid simpleCart_shelfItem'>
          <div style='height: 366px;' class='grid-pro'>
            ...
            <div class='women'>
              <h6  style='color: #ff0000;''>".utf8_encode($row['categoria'])."</a></h6>
              <p><em class='item_price'>".utf8_encode($row['municipio']).", Tlaxcala</em> <br></p><br>
              <a href='3vip?id=".$row['idAnuncio']."' data-text='Ver anuncio' class='but-hover1 item_add'>Ver anuncio</a>
            </div>
          </div><br><br>
        </div>
      ";
      ...
      echo "
        <div class='col-sm-4 item-grid simpleCart_shelfItem'>
          <div style='height: 366px;' class='grid-pro'>
            ...
            <div  class='grid-product' >
              <figure>  
                <a href='3empleos.php?id=".$row['idEmpleos']."'>
                  <div class='grid-img'>
                    <img src=".$row['img1']." class='img-responsive'>
                  </div>
                  <div class='grid-img'>
            ...
            <div class='women'>
              ...
              <p><em class='item_price'>".utf8_encode($row['municipio']).", Tlaxcala</em> <br></p><br>
              <a href='3empleos?id=".$row['idEmpleos']."' data-text='Ver empleo' class='but-hover1 item_add'>Ver empleo</a>
            </div>
          </div><br><br>
        </div>
      ";
