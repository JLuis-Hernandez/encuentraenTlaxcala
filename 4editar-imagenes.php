...
<!-- contact -->
	<div class="login">
		...
		<div class="page-header">
        	<h3>Logo de tu empresa y/o Negocio</h3>
      	</div>
<?php
...
die ('Error al seleccionar BD : ' . mysql_error());
    ...
    $query = "SELECT idAnuncio, nombreNegocio, descripcion, categoria, subcategoria, domicilio, codPostal, municipio, coloniaLocalidad, telefono, correoNegocio, facebook, twitter, whatsapp, linkSitioWeb, linkYoutube, linkGoogle, audio, img1, img2, img3, img4, img5 FROM anuncios where idCliente='".$_SESSION['sess_user_id']."' ";
...
mysql_select_db("encuen21_Tlaxcala");//nombre de la base de datos.
  if(isset($_POST['registrar'])){
    ...
    $sqlAnuncio = mysql_query("update anuncios set  img1='$dest_img1', img2='$dest_img2', img3='$dest_img3', img4='$dest_img4', img5='$dest_img5' where idCliente='".$_SESSION['sess_user_id']."' ");
    if($sqlAnuncio){
      echo "<script>alert('Las fotos se actualiso correctamente.');</script>";
