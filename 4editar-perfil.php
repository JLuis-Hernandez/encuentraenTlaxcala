...
die ('Error al seleccionar BD : ' . mysql_error());
    ...
    $query = "SELECT idAnuncio, nombreNegocio, descripcion, categoria, subcategoria, domicilio, codPostal, municipio, coloniaLocalidad, telefono, correoNegocio, facebook, twitter, whatsapp, linkSitioWeb, linkYoutube, linkGoogle FROM anuncios where idCliente='".$_SESSION['sess_user_id']."' ";
            ...
            <div class="col-md-6" data-wow-delay=".5s">
  			...
  			<div class="col-md-6" data-wow-delay=".5s">
                <div style="border-color: #079F37; border-width: 1px;" class="login-mail">
					<input style="background: #fff;" value="<?php echo $rsEmp['linkYoutube']; ?>"  name="video" type="text" placeholder="Telefono" required autofocus>
					<i><img width="16px;" src="images/iconos/youtube.png"></i>(Link video youtube)
				</div>
            </div>
            
            <div class="col-md-6" data-wow-delay=".5s">
                <div style="border-color: #079F37; border-width: 1px;" class="login-mail">
					<input style="background: #fff;" value="<?php echo $rsEmp['linkGoogle']; ?>"  name="mapa" type="text" placeholder="Telefono" required autofocus>
					<i><img width="16px;" src="images/iconos/domiciliof.png"></i>(Link google maps)
				</div>
            </div>
...
mysql_select_db("encuen21_Tlaxcala"); //nombre de la base de datos.
  if(isset($_POST['registrar'])){
    ...
    $sqlAnuncio = mysql_query("update anuncios set descripcion='$desc',   telefono='$telefono', correoNegocio='$correoEmpresa', 
    	whatsapp='$whats',facebook='$face', twitter='$twitter', linksitioweb='$web',linkGoogle='$mapa', linkYoutube='$video' where idCliente='".$_SESSION['sess_user_id']."' ");
    if($sqlAnuncio){
