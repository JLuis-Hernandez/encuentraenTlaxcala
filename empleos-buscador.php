...
<input class="barra_buscar" style="margin-top: 0px;"  name="servicio" id="serviciosearch" placeholder="&#191;Qu&#233; buscas&#63;"/>
  <!--<input class="barra_buscar" name="servicio" id="serviciosearch" placeholder="¿Qué buscas?"/>-->

  <select class="barra_buscar" style="margin-left: 360px; margin-top: -37px;" class="select" name="municipio">
        ...
        <input type="submit" class="signup-button" value="Buscar">
