<!-- header -->
	<div class="header">
			<div class="header-grid">
				<div class="container">
    				<div class="header-left" data-wow-delay=".5s">
    					<ul>
    						...
    						<li><a href="https://encuentraentlaxcala.com/empleos-index"><img style="width: 20px; margin-top: -10px;" src="images/logo-icono.png"> EL DIRECTORIO COMERCIAL WEB DEL ESTADO DE TLAXCALA</a></li>
    					</ul>
    				</div>
    				<div class="header-right" data-wow-delay=".5s">
        				...
        				<div style="margin-top: 8px;" class="header-right2">
        						<ul>
			...
			<div class="container">
			    <div class="logo-nav">
			        <form action="empleos-resultadodebusqueda" method="get">
    			        <div class="col-md-4">
    					<center><a href="https://encuentraentlaxcala.com/empleos-index"><h1 class="animated wow pulse" data-wow-delay=".5s"><img id="logito" src="images/logo.png"></h1></a></center>
    					</div>
    					<div class="col-md-3">
