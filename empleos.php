...
{
  $nombreCliente = utf8_decode(utf8_encode($row['nombreCliente']));
  $apellidosCliente = utf8_decode(utf8_encode($row['apellidosCliente'])); 
}
?>
              ...
              <div class="resp-tabs-container">
                   <h2 class="resp-accordion resp-tab-active" role="tab" aria-controls="tab_item-0"><span class="resp-arrow"></span>Descripci&#243;n</h2>
                    ...
                    <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
                        <div class="facts">
                             <ul>
                                <li title="Nombre de contacto"><img width="18px;" src="images/iconos/empresario.png"> <?php echo utf8_encode($nombreCliente); ?> <?php echo utf8_encode($apellidosCliente); ?></li>
